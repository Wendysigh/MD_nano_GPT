...
python -u train_trans.py --batch_type=window --interval=5 --trans_block=2 --gpu_id=1
python -u generation.py --gpu_id=1 --ckpt_choice=epoch40 --ckpt_task=Label0.0_window50_interval5_lr0.0005_emb_dim128_l100_block2_scheduled
